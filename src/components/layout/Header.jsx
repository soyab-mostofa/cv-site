...
const NavContainer = tw.div`bg-neutral-100/10 py-4 top-0 fixed w-full  z-50`;
...
const H1 = tw.h1`text-neutral-900 font-bold tracking-widest bg-clip-text bg-gradient-to-tr from-blue-700 to-amber-600 text-transparent`;
  ...
  return (
    <NavContainer>
      <NavContainerInner>
        ...
        <div className="relative z-40 md:hidden text-neutral-600">
