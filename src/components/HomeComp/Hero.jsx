...
const Container = tw(motion.div)`container px-4 mx-auto py-72 max-w-6xl`;
const Heading = tw(motion.h1)`text-4xl md:text-6xl font-semibold`;
const Sub = tw.p`text-2xl font-semibold my-4`;
const P = tw(motion.p)`md:text-lg mb-4 `;
const Background = tw.div`bg-gradient-to-tr from-neutral-900 to-red-900 text-neutral-50 `;
